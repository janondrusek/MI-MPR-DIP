\chapter{Implementation}\label{cha:implementation}
	...
	context configuration is split into multiple files, where the original \textbf{applicationContext.xml} server just as a
	parent and imports child configurations.
	...
	\begin{itemize}
		\item \textbf{deployment.properties} for development and \textbf{deployment.prod.properties} for production
		...
		Security deserves its own configuration file as it is quite complicated in this application. This, however, is just
		for readability.
	\end{itemize}
